// app/api/generate/route.ts — javari-fitness
...
const CREDIT_COST      = 5
const SYSTEM           = `You are a certified fitness expert and personal trainer. Create personalized workout plans, nutrition guides, progress tracking systems, and motivational content.`
const ACTIONS          = ["workout_plan", "nutrition_guide", "meal_plan", "progress_tracker", "fitness_assessment", "recovery_plan"]
